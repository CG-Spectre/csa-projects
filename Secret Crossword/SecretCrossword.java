...
public class SecretCrossword
{
    ...
    public int getEntryLength()
    {
        ...
        return crosswordClue.indexOf(" ");      // replace this line
    }
    ...
    public String getEntry()
    {
        ...
        return crosswordClue.split(" ")[0];      // replace this line
    }
    ...
    public String getClue()
    {
        ...
        // first blank space
        return crosswordClue.split(" ", 2)[1];      // replace this line
    }
    ...
    public String getFirstLetter()
    {
        ...
        return ""+this.getEntry().charAt(0);      // replace this line
    }
    ...
    public boolean isCorrectGuess(String guess)
    {
        ...
        return this.getEntry().equals(guess);   // replace this line
    }
}
